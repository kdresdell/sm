...
------------------------------------ */
	...
	global $exittext,$exit_classes,$NV_frame_footer, $NV_disablefooter,$NV_footer_divider;
	...
	<div id="footer-wrap">
		...
		if( of_get_option('lowerfooter') != "disable" )
		{
			...
			$lower_right = ( of_get_option('lowfooterright') !='' ) ? of_get_option('lowfooterright') : 'Powered by <a href="http://themeforest.net/user/themeva/portfolio?ref=themeva" title="Buy Theme" target="_blank">DynamiX</a>'; ?>
