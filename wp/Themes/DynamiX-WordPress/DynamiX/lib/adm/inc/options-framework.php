...
function optionsframework_init() {
	...
	if ( $optionsfile = locate_template( array('/lib/adm/options.php') ) ) {
		require_once($optionsfile);
	}
	else if (file_exists( dirname( __FILE__ ) . '/lib/adm/options.php' ) ) {
		require_once dirname( __FILE__ ) . '/lib/adm/options.php';
	}
...
function optionsframework_load_scripts($hook) {
	...
	// Enqueued scripts
	if( !empty($_REQUEST['page'])) $curr_page = $_REQUEST['page']; else $curr_page='';

	wp_enqueue_script('jquery-ui-core');

	if( $curr_page != "options-framework" )
	{
	...
	if($curr_page=="options-framework")
	{
		...
		wp_deregister_script( 'mr_social_sharing-admin' );
            ...
            <div id="optionsframework-metabox" class="metabox-holder">
                <div id="optionsframework">
                    <form action="options.php" method="post" id="options">
                        <div data-role="page" data-content-theme="c">
                            <div data-role="header" class="ui-bar-c">
									<a href="#" data-role="button" data-inline="true" data-mini="true" class="update_options ui-btn-right" data-theme="b" /><?php esc_attr_e( 'Save Options', 'optionsframework' ); ?></a>
									<a href="http://themeva.com/docs/<?php echo strtolower($theme_name); ?>/" target="_blank" data-role="button" data-mini="true" class="documentation_link ui-btn-left" /><?php esc_attr_e( 'Theme Documentation', 'optionsframework' ); ?></a> 
                                <span class="ui-title" />
                            </div>                        
                            ...
                            <div data-role="footer" class="ui-bar-c">
                                <a href="#" data-role="button" data-mini="true" class="update_options ui-btn-right" data-theme="b" /><?php esc_attr_e( 'Save Options', 'optionsframework' ); ?></a>
                                <a href="#" data-role="button" data-mini="true" class="reset_options ui-btn-left" /><?php esc_attr_e( 'Restore Defaults', 'optionsframework' ); ?></a>   	
								<span class="ui-title" />
                            </div>                
                        </div>
