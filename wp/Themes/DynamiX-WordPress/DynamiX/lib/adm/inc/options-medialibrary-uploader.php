...
if ( ! function_exists( 'optionsframework_medialibrary_uploader' ) ) {
	...
	function optionsframework_medialibrary_uploader( $_id, $_value, $_mode = 'full', $_desc = '', $_postid = 0, $_name = '', $_plac = '') {
		...
		$output .= '<input data-mini="true" id="' . $id . '" class="upload' . $class . '" type="text" placeholder="'. $_plac .'" name="'.$name.'" value="' . $value . '" />' . "\n";
		$output .= '<a href="#" data-role="button" data-mini="true" id="upload_' . $id . '" class="upload_button" data-inline="true" type="button" rel="' . $int . '" >' . __( 'Upload', 'optionsframeworktheme' ) . ' </a>' . "\n";
