...
function of_sanitize_raw($input) {
...
add_filter( 'of_sanitize_raw', 'of_sanitize_raw' );
...
add_filter( 'of_sanitize_switch', 'of_sanitize_enum', 10, 2);
...
add_filter( 'of_sanitize_radio_inline', 'of_sanitize_enum', 10, 2);
