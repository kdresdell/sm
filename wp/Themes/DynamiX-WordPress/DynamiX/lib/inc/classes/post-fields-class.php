 ...
 */
	...
	if( is_single() )
	{
		if( $NV_displayblogimage != 'archive' && ( of_get_option('arhpostcontent') == 'excerpt_image' || of_get_option('arhpostcontent') == 'image_only' || of_get_option('arhpostcontent') == '' || $NV_displayblogimage == 'single' ||  $NV_displayblogimage == 'singlearchive' ) )
		{
	...
	elseif( !is_single() )
	{
		if( $NV_displayblogimage !='single' && ( of_get_option('arhpostcontent') == 'excerpt_image' || of_get_option('arhpostcontent') == 'image_only' || of_get_option('arhpostcontent') == '' || $NV_displayblogimage == 'archive' ||  $NV_displayblogimage == 'singlearchive' ) )
		{
			$NV_displayblogimage = 'display';
		}
	}
