...
------------------------------------*/ 
                    ...
                    <div id="toggle">
                        <ul class="icon-dock clearfix">
                            ...
                            { ?>  
                                <li class="searchform">
                                    <form method="get" id="panelsearchform" action="<?php echo home_url(); ?>" class="active">
                                        <fieldset>
                                            <input type="text" name="s" id="drops" value="<?php _e('Search', 'themeva' ); ?>" onFocus="if(this.value == '<?php _e('Search', 'themeva' ); ?>') {this.value = '';}" onBlur="if (this.value == '') {this.value = '<?php _e('Search', 'themeva' ); ?>';}" />
                            ...
                            if( of_get_option('header_customfield') )
                            {
                                ...
                                echo '<li class="customfield '. $class .'"><span class="break"></span><div class="custom-content">'.do_shortcode( of_get_option('header_customfield') ).'</div></li>'; 
                            }
	...
	{				
		echo "\n". '<div id="mobile-tabs" class="skinset-main nv-skin">';
	
		echo '<div class="mobilemenu-init skinset-main nv-skin"><a href="#"><i class="fa fa-times fa-lg"></i></a></div>';
	...
	<div class="header-wrap <?php echo $page_type; ?>">
        ...
        <div class="wrapper">
            ...
            if( get_option('branding_disable') !='disable' ) : ?>
				...
				if( of_get_option('mobile_menu') != 'select' )
				{
					echo '<div class="mobilemenu-init skinset-main nv-skin"><a href="#"><i class="fa fa-bars fa-lg"></i></a></div>';
				} ?>  
                ...
                // WP3.0 Custom Menu Support
                    if( of_get_option('wpcustomm_enable') !='disable' ) : 
                        ...
                        if( $menu_slug != 'disable' ) :
                            ...
                            if ( !class_exists('UberMenu') && ( of_get_option('enable_responsive') !='disable' && of_get_option('mobile_menu') == 'select' ) ) : // check if responsive is disabled
