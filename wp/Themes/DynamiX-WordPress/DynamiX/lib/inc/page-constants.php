...
------------------------------------*/
	...
	$NV_gallerycat = 		  ( get_post_meta( $post->ID, '_cmb_data-2', false ) !='' ) 			? get_post_meta( $post->ID, '_cmb_data-2', false ) : '';
	...
	$NV_slidesetid = 		  ( get_post_meta( $post->ID, '_cmb_data-4', false ) !='' ) 			? get_post_meta( $post->ID, '_cmb_data-4', false ) : '';	
	$NV_productcat = 		  ( get_post_meta( $post->ID, '_cmb_data-5', false ) !='' ) 			? get_post_meta( $post->ID, '_cmb_data-5', false ) : '';
	$NV_producttag = 		  ( get_post_meta( $post->ID, '_cmb_data-5-tags', false ) !='' ) 		? get_post_meta( $post->ID, '_cmb_data-5-tags', false ) : '';
	$NV_mediacat = 		  ( get_post_meta( $post->ID, '_cmb_data-6', false ) !='' ) 			? get_post_meta( $post->ID, '_cmb_data-6', false ) : '';
	$NV_pagepost_id =	 	  ( get_post_meta( $post->ID, '_cmb_data-8', true ) !='' ) 				? get_post_meta( $post->ID, '_cmb_data-8', true ) : '';
	$NV_archivecat =		  ( get_post_meta( $post->ID, '_cmb_archivecat', false ) !='' ) 		? get_post_meta( $post->ID, '_cmb_archivecat', false ) : '';
	$NV_filterformats =	  ( get_post_meta( $post->ID, '_cmb_filter_formats', false ) !='' ) 	? get_post_meta( $post->ID, '_cmb_filter_formats', false ) : '';
